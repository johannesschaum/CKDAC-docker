...
# pwd: '$ADAPTER_SERVICE_PW',
# roles: [
# { role: "readWrite", db: "$ADAPTER_DB_NAME" }
# ],
# mechanisms: [
# "SCRAM-SHA-1",
# "SCRAM-SHA-256"
...
# pwd: '$AUTH_SERVICE_PW',
# roles: [
# { role: "readWrite", db: "$AUTH_DB_NAME" }
# ],
# mechanisms: [
# "SCRAM-SHA-1",
# "SCRAM-SHA-256"
...
# pwd: '$MAPPING_SERVICE_PW',
# roles: [
# { role: "readWrite", db: "$MAPPING_DB_NAME" }
# ],
# mechanisms: [
# "SCRAM-SHA-1",
# "SCRAM-SHA-256"
...
# pwd: '$USER_SERVICE_PW',
# roles: [
# { role: "readWrite", db: "$USER_DB_NAME" }
# ],
# mechanisms: [
# "SCRAM-SHA-1",
# "SCRAM-SHA-256"
...
# {"_id":{"$oid":"5e14d2d26ed91211d6b56246"},"name":"listApis","activities":[{"$oid":"5e14c7066ed91211d6b540d9"}]}
...
# mongoimport --username=$CLUSTER_ADMIN_USER --password=$CLUSTER_ADMIN_PW --authenticationDatabase=admin --db=user-service --collection=users <<USERS
...
# ROLES
# # {"_id":{"$oid":"5dcad79be032c89c33eda9ff"},"name":"god","claims":["admin"],"users":[{"$oid":"5dcad79be032c89c33eda9f4"}],"services":[{"$idx":"$API_SERVICE_USER"}, {"$idx":"$ADAPTER_SERVICE_USER"}, {"$idx":"$AUTH_SERVICE_USER"}, {"$idx":"$MAPPING_SERVICE_USER"}, {"$idx":"$USER_SERVICE_USER"}],"permissions":[{"$oid":"5dcad79be032c89c33eda9fe"}]}
# # eingetragene services so korrekt? (Zeile 116)
...
# key: '$API_SERVICE_USER_API_KEY',
# expiryDate: expiryDate
# },
# {
# name: '$ADAPTER_SERVICE_USER',
# key: '$ADAPTER_SERVICE_USER_API_KEY',
# expiryDate: expiryDate
# },
# {
# name: '$AUTH_SERVICE_USER',
# key: '$AUTH_SERVICE_USER_API_KEY',
# expiryDate: expiryDate
# },
# {
# name: '$MAPPING_SERVICE_USER',
# key: '$MAPPING_SERVICE_USER_API_KEY',
# expiryDate: expiryDate
# },
# {
# name: '$USER_SERVICE_USER',
# key: '$USER_SERVICE_USER_API_KEY',
# expiryDate: expiryDate
# }
# ]);
# APIKEYS
...
mongoimport --username=$CLUSTER_ADMIN_USER --password=$CLUSTER_ADMIN_PW --authenticationDatabase=admin --db=auth-service --collection=activities <<"ACTIVITIES"
{"_id":{"$oid":"5dcad79be032c89c33eda9fd"},"name":"god","method":"*","url":"^.*$"}
{"_id":{"$oid":"5e14c65d6ed91211d6b53f17"},"name":"getUser","method":"GET","url":"^.*/(api|auth)/users/[^/]+/?$"}
{"_id":{"$oid":"5e14c7066ed91211d6b540d9"},"name":"listUsers","method":"GET","url":"^.*/(api|auth)/users/?(\\?([^=\u0026]+?=[^=\u0026]+?)(\u0026[^=\u0026]+?=[^=\u0026]+?)*)?$"}
{"_id":{"$oid":"5e14c7416ed91211d6b5417f"},"name":"createUser","method":"POST","url":"^.*/(api|auth)/users/?$"}
{"_id":{"$oid":"5e14c7696ed91211d6b541fd"},"name":"updateUser","method":"PUT","url":"^.*/(api|auth)/users/[^/]+/?$"}
{"_id":{"$oid":"5e14c7b76ed91211d6b542c6"},"name":"deleteUser","method":"DELETE","url":"^.*/(api|auth)/users/[^/]+/?$"}
{"_id":{"$oid":"5e14ca606ed91211d6b54a87"},"name":"getApi","method":"GET","url":"^.*/(api|auth)/apis/[^/]+/?$"}
{"_id":{"$oid":"5e14caca6ed91211d6b54b98"},"name":"listApis","method":"GET","url":"^.*/(api|auth)/apis/?(\\?([^=\u0026]+?=[^=\u0026]+?)(\u0026[^=\u0026]+?=[^=\u0026]+?)*)?$"}
{"_id":{"$oid":"5e14cb326ed91211d6b54cdd"},"name":"createApi","method":"POST","url":"^.*/(api|auth)/apis/?$"}
{"_id":{"$oid":"5e14cb576ed91211d6b54d59"},"name":"updateApi","method":"PUT","url":"^.*/(api|auth)/apis/[^/]+/?$"}
{"_id":{"$oid":"5e14cbb46ed91211d6b54e37"},"name":"deleteApi","method":"DELETE","url":"^.*/(api|auth)/apis/[^/]+/?$"}
{"_id":{"$oid":"5e14cf5f9db771209adf8308"},"name":"getMapping","method":"GET","url":"^.*/(api|auth)/mappings/(?!generate(/|$))[^/]+/?$"}
{"_id":{"$oid":"5e14cfab9db771209adf830b"},"name":"listMappings","method":"GET","url":"^.*/(api|auth)/mappings/?(\\?([^=\u0026]+?=[^=\u0026]+?)(\u0026[^=\u0026]+?=[^=\u0026]+?)*)?$"}
{"_id":{"$oid":"5e14cfdb9db771209adf830e"},"name":"createMapping","method":"POST","url":"^.*/(api|auth)/mappings/?$"}
{"_id":{"$oid":"5e14cfe59db771209adf830f"},"name":"updateMapping","method":"PUT","url":"^.*/(api|auth)/mappings/(?!generate(/|$))[^/]+/?$"}
{"_id":{"$oid":"5e14cffe9db771209adf8311"},"name":"deleteMapping","method":"DELETE","url":"^.*/(api|auth)/mappings/(?!generate(/|$))[^/]+/?$"}
{"_id":{"$oid":"5e14cffe9db771209adf8312"},"name":"generateMapping","method":"POST","url":"^.*/(api|auth)/mappings/generate/?$"}
{"_id":{"$oid":"5e14d2219db771209adf8313"},"name":"createAdapter","method":"POST","url":"^.*/(api|auth)/adapters/generate/[^/]+/?$"}
{"_id":{"$oid":"5e14d2219db771209adf8314"},"name":"createAdapter","method":"GET","url":"^.*/(api|auth)/adapters/download/[^/]+/?$"}
ACTIVITIES
